...
object WebSocketsDemo extends App {
  ...
  val websocketFlow :Flow[Message, Message,Any] = Flow[Message].map{
    ...
    case bm: BinaryMessage =>
      ...
      TextMessage(Source.single("Server recived a binary message..."))
  }
  ...
  Http().bindAndHandle(webSocketsRoute,"localhost",8080)
  ...
  val socialFeed = Source(
    List(
      ...
      SocialPost("Daniel", "A new Rock the JVM is open!"),
